...
public class TransferMarketController extends BuySell {
    ...
    @FXML
    private void handleTransferListed(ActionEvent event) throws IOException {
        System.out.println("TransferMarketController.transferListedPlayer called - username: " + username + ", userTeam: " + userTeam);
        URL resource = getClass().getResource("transfer_listed.fxml");
        if (resource == null) {
