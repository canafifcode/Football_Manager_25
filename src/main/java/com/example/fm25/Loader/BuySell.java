...
public class BuySell {
    private Map<String, PlayerLoader> availablePlayers;
    private Map<String, PlayerLoader> ownedPlayers;
    ...
    private void updatePlayersFile(PlayerLoader player, String newTeam) {
        try {
    ...
    public Map<String, PlayerLoader> getAvailablePlayers() {
        return availablePlayers;
    }

    public Map<String, PlayerLoader> getOwnedPlayers() {
        return ownedPlayers;
    }
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(fileName))) {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (parts.length >= 6 && parts[1].trim().equals(userTeam)) {
                    ...
                    PlayerLoader player = new PlayerLoader(name, position, "League", userTeam, stats, overall);
