...
public class PlayerLoader implements Serializable {
    private String name;
    ...
    public PlayerLoader(String name, String position, String league, String team, Map<String, Integer> stats, int overall) {
        this.name = name;
    ...
    public List<PlayerLoader> loadPlayersForTeam(String teamName) {
    ...
    public List<PlayerLoader> loadPlayersForMySell(String username) {
        List<PlayerLoader> players = new ArrayList<>();
